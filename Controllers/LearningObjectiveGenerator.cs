...
namespace SK_API.Controllers{
    ...
    public partial class LOGeneratorController : ControllerBase
    {
        ...
        public async Task<IActionResult> LOAnaliserInputAsync([FromHeader(Name = "ApiKey")] string token, [FromHeader(Name = "SetupModel")] LLM_SetupModel setupModel, [FromBody] LORM input){
            try{
