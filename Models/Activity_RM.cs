...
public class ActivityInputModel{
    ...
    public ActivityInputModel(string macroSubject, string title, TextLevel level, TypeOfActivity typeOfActivity, string learningObjective, BloomLevel bloomLevel, string material, TypeOfAssignment assignmentType, string topic, string language = "english", int correctAnswersNumber = 1, int distractorsNumber = 1, int easilyDiscardableDistractorsNumber = 1, double temperature = 0.1){
